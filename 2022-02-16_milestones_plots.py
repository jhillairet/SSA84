...
ax[0].set_title(f'SSA84 - {data.date} - {data.time} - f={data.fMHz} MHz')
# ax[-1].set_xticklabels(ax[-1].get_xticklabels(), rotation=45)
ax[-1].set_xlim((57959364919.35484, 198261000000.0))
fig.savefig('SSA84_milestone5.png', dpi=150)

#%%
TResonatorData('data/2022-02-17_SSA84_RF_tests/WRF_2022-02-17_09-05-51_F61,740000M.tdms')
...
ax[0].set_title(f'SSA84 - {data.date} - {data.time} - f={data.fMHz} MHz')
# ax[-1].set_xticklabels(ax[-1].get_xticklabels(), rotation=45)
fig.savefig('SSA84_milestone5_2.png', dpi=150)
